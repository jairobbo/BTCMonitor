...
class TableViewController: UITableViewController {
    ...
    let headerData = ["First", "Second", "Third"]
    let headerView = UIImageView(image: #imageLiteral(resourceName: "headerimg"))
    
    override func viewDidLoad() {
        super.viewDidLoad()
        headerView.contentMode = .scaleAspectFill
        headerView.clipsToBounds = true
        headerView.frame = CGRect(x: 0, y: -20, width: view.bounds.width, height: 20)
